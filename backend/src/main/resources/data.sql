/*LANGUAGES*/
INSERT INTO
    language (language_id, language, imports, main)
VALUES
    (
        1,
        'Java',
...
VALUES
    (1, 1, 'Zbrojite dva broja', null, '3 4', '7');
...
VALUES
    (2, 1, 'Oduzmite dva broja', null, '3 4', '-1');
...
/* TASK COMMENTS */
INSERT INTO
    task_comment (task_comment_id, comment, commenter_id, task_id)
VALUES
    (1, 'Ne sviđa mi se.', 2, 1);
...
INSERT INTO
    task_comment (task_comment_id, comment, commenter_id, task_id)
VALUES
    (3, 'Potrudit cu se ubuduce da budu bolji!', 1, 1);

INSERT INTO
    task_comment (task_comment_id, comment, commenter_id, task_id)
VALUES
    (4, 'Bolje ga obrisi!', 4, 1);

INSERT INTO
    task_comment (task_comment_id, comment, commenter_id, task_id)
VALUES
    (5, 'Apsolutna koma...', 3, 1);
...
VALUES
    (1, 'Veoma jednostavno i elegantno.', 2, 1);
...
VALUES
    (4, 'Daj razmisli jel se može kraće.', 4, 2);

/* SOLUTION GRADES */
INSERT INTO
    solution_grade (solution_grade_id, grade, grader_id, solution_id)
VALUES
    (1, 2, 1, 1);
