...
\begin{document}
	...
	\chapter{Uvod}
	Sveprisutnost računalnih sustava tijekom početka 21. stoljeća uveliko je doprinijela većem porastu zanimacije populacije prema svemu što je povezano s računalima.  Naravno, to podrazumijeva i  \textbf{programiranje}. Programiranje možemo opisati kao proces opisivanja algoritma nekim od programskih jezika.\\
	...
	\label{cha:zahtjevi}
	Internetska stranica s elementima društvenih mreža koja podržava zadavanje i rješavanje programskih zadataka omogućuje korisniku ispunjavanje mješavine elementarnih \textbf{funkcionalnih} i \textbf{nefunkcionalnih} zahtjeva koje stranice oba navedena tipa ispunjavaju.
