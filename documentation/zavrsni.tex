...
\begin{document}
	...
	\chapter{Arhitektura rješenja}
		...
		Tablica \textbf{solution\_grading} unutar baze podataka ppredstavlja ocjene povezane uz jedno programsko rješenje. Vlastiti atributi solution\_grading tablice su solution\_grading\_id, grade, grader\_id i solution\_id. 
		\begin{table}[H]
	...
	Unaprjeđenje sustava spremanja rješenja koje bi bilo pogodno implementirati jest projvera plagijata tijekom dodavanja novog rješenja. Trenutačna verzija aplikacije ni na koji način ne provjerava sličnost rješenja te korisnici mogu veoma jednostavno u potpunosti kopirati već postojeća rješenja drugih korisnika. Sustav spremanja također ne pruža mogučnost spremanja nedovršenog rješenja programskog zadatka. Dodavanje te mogućnosti uveliko bi poboljšalo korisničko iskustvo te je još jedno od poželjnih unaprjeđenja.
